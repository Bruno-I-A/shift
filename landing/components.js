...
function MarkA({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    className: `${className} ${animate ? 'mark-shift' : ''}`
...
function Wordmark({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: `font-sans font-semibold tracking-tight leading-none ${dims.font}`
  }, "Shift", /*#__PURE__*/React.createElement("span", {
    className: "text-purple"
  }, "."), /*#__PURE__*/React.createElement("span", {
    className: "ml-1 font-mono font-normal text-[0.55em] tracking-[0.3em] uppercase text-white/55 align-middle"
  }, "Systems")));
}
...
function Section({
  ...
  return /*#__PURE__*/React.createElement("section", {
    id: id,
    className: `relative px-6 md:px-12 lg:px-20 py-28 md:py-36 ${className}`
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "num-tag"
  }, num), eyebrow && /*#__PURE__*/React.createElement("span", {
    className: "eyebrow"
  }, eyebrow)), title && /*#__PURE__*/React.createElement("h2", {
    className: "display text-4xl md:text-6xl lg:text-7xl max-w-5xl mb-8 build"
  }, title), intro && /*#__PURE__*/React.createElement("p", {
    className: "text-lg md:text-xl text-white/65 max-w-3xl mb-16 leading-relaxed reveal"
  }, intro), children));
}
    ...
    const walk = node => {
      Array.from(node.childNodes).forEach(child => {
        if (child.nodeType === 3) {
          ...
          parts.forEach(tok => {
            if (tok === '') return;
            if (/^\s+$/.test(tok)) frag.appendChild(document.createTextNode(tok));else {
...
function useCinematic() {
  React.useEffect(() => {
    ...
    ST.create({
      ...
      onUpdate: self => {
        window.__shiftScrollN = self.progress;
      }
    });
...
const Icon = {
  ...
  Spark: ({
    ...
    d: "M15.6 15.6l2.8 2.8"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M18.4 5.6l-2.8 2.8"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M8.4 15.6l-2.8 2.8"
  })),
  Bars: ({
    s = 22
  }) => /*#__PURE__*/React.createElement("svg", {
  ...
  Link: ({
    ...
    d: "M10.5 6.5L13 4a4 4 0 0 1 5.7 5.7L16 12.5"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M13.5 17.5L11 20a4 4 0 0 1-5.7-5.7L8 11.5"
  })),
  Alert: ({
    s = 22
  }) => /*#__PURE__*/React.createElement("svg", {
